...
wals_200_causative <- read_tsv("../data/wals_200_applicative.csv")
wals_200_applicative <- read_tsv("../data/wals_200_causative.csv")

## Define colors for maps
pal <- colorFactor(palette = wes_palette(name = "Zissou1")[c(2,5)],  domain = levels(wals_200_syncretism$causative_111a))
pal2 <- colorFactor(palette = wes_palette(name = "Zissou1")[c(5)],  domain = levels(wals_200_syncretism$reported))
```


```{r out.width='100%', fig.height=6, eval=require('leaflet'), echo=FALSE}
leaflet(wals_200_causative) %>% 
